<template>
  <div class="section">
    ...
    <div class="container">
      <div
        class="alert alert-success fade show mt-3 col-lg-6 col-md-6 col-sm-6"
        role="alert"
        id="success-alert"
        v-if="showAlert"
      >
        <p>
          <strong> Success! </strong> Your idea has been successfully added.
        </p>
      </div>
...
export default {
    ...
    methods: {
        saveUser() {
            ...
            axios.post("https://leadingfront.backendless.app/api/data/hack", {
                "title": this.title,
